// Coordenadas do Depósito como âncora geográfica
export const STORE_COORDS: [number, number] = [-22.9112951, -43.5602961];
...
export async function geocodeAddress(
  ...
  // Fallback Final Seguro: Coordenadas do Depósito de Bebidas
  console.warn(`[geocoding] Geocodificação falhou completamente para "${cleanStreet}". Usando coordenadas do Depósito como fallback.`);
  return STORE_COORDS;
}
